...
export const PLATFORMS: Platform[] = [
  ...
  { id: 'simplysouth', name: 'Simply South', short: 'Simply South', mark: 'SS', accent: '#F0384B', accent2: '#FF8A9B', tmdb: [1885],     regions: ['IN'],       homeUrl: 'https://www.simplysouth.tv/', searchUrl: 'https://www.simplysouth.tv/search?q={q}' },
